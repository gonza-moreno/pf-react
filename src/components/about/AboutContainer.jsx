...
const AboutContainer = () => {
  return (
    <div>
      <section
        className={`bg-about-2 bg-cover bg-center h-screen flex items-center justify-start text-end text-white`}
      >
      ...
      <section
        className={`bg-about-1 bg-cover bg-center h-screen flex items-center justify-end text-center text-white`}
      >
      ...
      <section
        className={`bg-guitarras-2 bg-cover bg-center min-h-[120vh] flex items-center justify-start text-center text-white`}
      >
        <div className="bg-slate-700 p-8 rounded-xl bg-opacity-60 ml-8">
